...
// AddNamespace provides a mock function with given fields: namespace
func (_m *ClusterCache) AddNamespace(namespace string) error {
...
// EnsureSynced provides a mock function with no fields
...
// GetAPIResources provides a mock function with no fields
...
// GetGVKParser provides a mock function with no fields
...
// GetOpenAPISchema provides a mock function with no fields
...
// RemoveNamespace provides a mock function with given fields: namespace
func (_m *ClusterCache) RemoveNamespace(namespace string) error {
	ret := _m.Called(namespace)
